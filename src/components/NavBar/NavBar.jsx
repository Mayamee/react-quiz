...
import { makeLinkToDrawer, removeLinksFromDrawer } from '../../helpers/makeLinksToDrawer'
...
const NavBar = ({ isAuth }) => {
  ...
  return (
    <div className={classes.NavBar}>
      <Drawer links={links} isOpen={isMenuOpen} onClose={() => setMenuOpen(false)} />
      <MenuToggle onToggle={() => setMenuOpen(!isMenuOpen)} isOpen={isMenuOpen} />
    </div>
  )
}
